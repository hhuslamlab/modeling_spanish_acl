"""
take the dataframe with incorrect predictions and the seen triples. report numbers. L-forms

Usage:
    section_6_4_2_unattested_l_shape.py --condition=<c> --train_triples_set=<tt>
...
if __name__ == "__main__":
    ...
    for model in input_condition:
        ...
        unattested_triples_df = pd.read_csv(
            "../../data/fixed_run/analysis/memorization_generalization/l_shape/section_6_4_2/unattested/triples_"
            + train_triples_set
            + "/"
            + condition
            + "/"
        ...
        new_df.to_csv(
            "../../data/fixed_run/analysis/memorization_generalization/l_shape/section_6_4_2/unattested/counts_"
            + train_triples_set
            + "/"
            + condition
            + "/"
