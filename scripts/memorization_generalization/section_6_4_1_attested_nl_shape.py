...
Usage:
    section_6_4_2_attested_nl_shape.py --condition=<c> --train_triples_set=<tt>
...
if __name__ == "__main__":
    ...
    for model in input_condition:
        ...
        new_df.to_csv(
            "../../data/fixed_run/analysis/memorization_generalization/nl_shape/section_6_4_1/attested/triples_"
            + train_triples_set
            + "/"
            + condition
            + "/"
