...
from lshape_memorize import get_lshaped_forms, get_shape
...
if __name__ == "__main__":
    for model in all_models:
        ...
        # else:
        #     df["per_unseen_triples_correct"] = [round(len(unseen_triples_correct_predictions)/len(total_unattested_l)*100, 2)]
        df.to_csv(
