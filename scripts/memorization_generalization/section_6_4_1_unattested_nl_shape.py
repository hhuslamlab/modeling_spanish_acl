"""
Unattested triples > incorrect predictions > check if this incorrect prediction's triple is seen in training for NL-shape forms.
...
from prepare_unattested_dataframes_nl_shape import (
    get_train_triples,
    get_train_triples_nl,
    get_train_tgts,
)
...
if __name__ == "__main__":
    ...
    for model in input_condition:
        ...
        if train_triples_set == "nl":
            ...
            all_triples = [str(tr) for tr in train_triples_nl]
        ...
        new_df.to_csv(
            "../../data/fixed_run/analysis/memorization_generalization/nl_shape/section_6_4_1/unattested/triples_"
            + train_triples_set
            + "/"
            + condition
            + "/"
