...
if __name__ == "__main__":
    ...
    for model in input_condition:
        ...
        attested_triples_df = pd.read_csv(
            "../../data/fixed_run/analysis/memorization_generalization/nl_shape/section_6_4_2/attested/triples_"
            + train_triples_set
            + "/"
            + condition
            + "/"
        ...
        new_df.to_csv(
            "../../data/fixed_run/analysis/memorization_generalization/nl_shape/section_6_4_2/attested/counts_"
            + train_triples_set
            + "/"
            + condition
            + "/"
